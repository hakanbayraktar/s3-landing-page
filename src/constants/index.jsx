export const features = [
  {
    ...
    caption: "Kolay Entegrasyon",
    title: "Daha zekice çalışın, yorulmayın",
    text: "Dijital Mecra ile sıkıcı işler artık tarih oldu. Otomasyon ve akıllı süreçler verimliliğinizi zirveye taşır. Kahvenizden bir yudum alırken işlerinizin kendiliğinden hallolmasını izleyin.",
    button: {
  ...
  },
  {
    ...
    caption: "Güvenli ve Şeffaf",
    title: "İçiniz rahat olsun, biz buradayız",
    text: "Veri güvenliğiniz bizim önceliğimizdir. En son şifreleme teknolojileri ve güçlü gizlilik kontrolleri ile verileriniz her zaman güvende. Dijital Mecra ile dijital kaleniz her zaman koruma altında.",
    button: {
...
export const details = [
  {
    ...
    title: "Yapay zeka video kurgu",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Ekibinizle ortak çalışın",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Süper hızlı bulut sistemi",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "Dijital Mecra kurulumu ne kadar kolay?",
    answer:
      "Oldukça kolay! Saniyeler içinde hesabınızı oluşturup hemen içerik üretmeye başlayabilirsiniz. Karmaşık ayarlar yok, sadece yaratıcılığınıza odaklanın.",
  },
  {
    id: "1",
    question: "Diğer platformlarla entegre edebilir miyim?",
    answer:
      "Evet! Sosyal medya hesaplarınızdan bulut depolama servislerine kadar tüm popüler platformlarla tam uyumlu çalışıyoruz.",
  },
  {
    id: "2",
    question: "Yeni özellikler ne sıklıkla ekleniyor?",
    answer:
      "Yapay zeka dünyasını yakından takip ediyor ve her ay sistemimize yeni yetenekler ekliyoruz.",
  },
  {
    id: "3",
    question: "İade politikanız nedir?",
    answer:
      "Müşteri memnuniyeti bizim için her şeydir. Eğer memnun kalmazsanız ilk 14 gün içinde koşulsuz iade talep edebilirsiniz.",
  },
  {
    id: "4",
    question: "Kurumsal çözümleriniz var mı?",
    answer:
      "Büyük ekipler ve ajanslar için özel 'Kurumsal' paketimiz ve size özel danışmanlık hizmetimiz mevcuttur.",
  },
  {
    id: "5",
    question: "Depolama alanım dolduğunda ne olur?",
    answer:
      "Size anında bildirim gönderiyoruz. İstediğiniz zaman paketinizi yükseltebilir veya ek alan satın alabilirsiniz.",
  },
  {
    id: "6",
    question: "Paketimi istediğim zaman değiştirebilir miyim?",
    answer:
      "Kesinlikle! İster yükseltin ister küçültün, kararlarınızda tamamen özgürsünüz.",
  },
  {
    id: "7",
    question: "Ekibimi nasıl davet ederim?",
    answer:
      "Yönetim panelinden e-posta adreslerini girerek saniyeler içinde ekibinizi çalışma alanınıza dahil edebilirsiniz.",
  },
  {
    id: "8",
    question: "Eğitim veriyor musunuz?",
    answer:
      "Hem bireysel hem de ekipler için detaylı video rehberlerimiz ve canlı webinarlarımız bulunmaktadır.",
  },
  {
    id: "9",
    question: "Hesabıma erişemiyorum, ne yapmalıyım?",
    answer:
      "Panik yapmayın! Destek ekibimiz 7/24 yanınızda. Hemen bize ulaşın, sorununuzu saniyeler içinde çözelim.",
  },
];
...
export const testimonials = [
  {
    id: "0",
    name: "Ceren Yılmaz",
    role: "Global İletişim",
    avatarUrl: "/images/testimonials/jessica-saunders.png",
    comment:
      "Dijital Mecra'nın desteği tek kelimeyle mükemmel! Ne zaman ihtiyacım olsa teknoloji kahramanlarım gibi yanımdalar.",
  },
  {
    id: "1",
    name: "Murat Ekinci",
    ...
    comment:
      "Başta şüpheliydim ama artık içerik operasyonlarımızı onsuz hayal bile edemiyorum. Gerçekten fark yaratıyorlar.",
  },
  {
    id: "2",
    name: "Melis Aydın",
    role: "Dijital Girişim",
    avatarUrl: "/images/testimonials/melanie-hurst.png",
    comment:
      "Bu yazılımı kullanmaya başlamak hayatımın en iyi kararlarından biriydi. Günlük işlerimi çok daha basit hale getirdi.",
  },
  {
    id: "3",
    name: "Ali Demir",
    role: "Teknoloji Odası",
    avatarUrl: "/images/testimonials/alicia-barker.png",
    comment:
      "Analiz özelliği adeta bir gelecek okuyucu gibi. İş kararlarımızı verirken en büyük yardımcımız oldu.",
  },
  {
    id: "4",
    name: "Selin Yıldız",
    ...
    comment:
      "Geçen ay geçiş yaptık ve şimdiden sonuçları görüyoruz. Ekibimiz için verilmiş en iyi karar!",
  },
  {
    id: "5",
    name: "Caner Öztürk",
    role: "Video Prodüksiyon",
    avatarUrl: "/images/testimonials/jim-bradley.png",
    comment:
      "Verimlilik artışı inkar edilemez. Bu platform çalışma şeklimizi sonsuza dek değiştirdi.",
  },
];
